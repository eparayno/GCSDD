// File Name: SortedListInterface.h
// Author name: Erika Parayno (SID: 1425156)
// Date: October 23, 2019
// Description: This class is the SortedListInterface from Carrano and Henry's Data Abstraction and Problem Solving
// with C++ (6th edition). It is a template interface of SortedList which is used by LinkedSortedList.
